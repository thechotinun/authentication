...
// @Accept json
// @Produce json
// @Param body body models.CreateBook true "Book object that needs to be added to the store"
// @Success 200 {object} models.Book
// @Security ApiKeyAuth
// @Router /v1/book [post]
...
// @Produce json
// @Param id path string true "Book ID"
// @Param body body models.UpdateBook true "Book object that needs to be added to the store"
